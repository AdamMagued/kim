# CLAUDE.md — Kim Agent Platform (root router)
...
## Test commands
```
python -m pytest tests/           # 816+ Python tests
cd desktop && npm run test        # 31 Vitest tests
cd desktop/src-tauri && cargo test # 50 Rust tests
```
