...
# Approval previews live in mcp_server/previews.py (extracted for the
# file-size gate); re-exported here because callers and tests patch
# mcp_server.policy.build_approval_preview.
from mcp_server.previews import build_approval_preview  # noqa: E402,F401
