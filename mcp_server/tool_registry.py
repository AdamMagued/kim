...
from mcp_server.tool_schemas_parity import (
    PARITY_FILE_TOOLS, PARITY_SCREEN_DISPATCH, PARITY_SCREEN_TOOLS,
    PARITY_SHELL_DISPATCH, PARITY_SHELL_TOOLS, PARITY_WEB_DISPATCH, PARITY_WEB_TOOLS)
...
_FILE_TOOLS: list[Tool] = PARITY_FILE_TOOLS + [
    Tool(
        name="write_file",
...
# Merged for DISPATCH aggregation (no behavior change without a tier filter).
_FILE_DISPATCH = {**_FILE_READ_DISPATCH, **_FILE_WRITE_DISPATCH}


# ── Shell execution ──────────────────────────────────────────────────────────

_SHELL_TOOLS: list[Tool] = PARITY_SHELL_TOOLS + [
    Tool(
        name="run_command",
...
_SCREEN_TOOLS: list[Tool] = PARITY_SCREEN_TOOLS + [
    Tool(
...
_WEB_TOOLS: list[Tool] = PARITY_WEB_TOOLS + [
    Tool(
        name="web_open",
        description=(
