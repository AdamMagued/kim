...
struct BuiltRuntime {
    runtime: Option<ConversationRuntime<file_bridge::EitherClient, CliToolExecutor>>,
    plugin_registry: PluginRegistry,
    plugins_active: bool,
    mcp_state: Option<Arc<Mutex<RuntimeMcpState>>>,
    mcp_active: bool,
...
impl BuiltRuntime {
    fn new(
        runtime: ConversationRuntime<file_bridge::EitherClient, CliToolExecutor>,
        plugin_registry: PluginRegistry,
        mcp_state: Option<Arc<Mutex<RuntimeMcpState>>>,
    ) -> Self {
        Self {
...
impl Deref for BuiltRuntime {
    type Target = ConversationRuntime<file_bridge::EitherClient, CliToolExecutor>;
