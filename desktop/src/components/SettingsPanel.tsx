...
import type { Settings, Provider, Theme, VoiceEngine, VoiceSettings, KimAccount, GoogleAccount, GoogleApiAccount, TypingAnimation } from '../types';
import { VOICES_BY_ENGINE } from '../types';
import { toast } from './Toast';
import { PairingModal } from './PairingModal';
import { PROVIDERS, VOICE_ENGINES, ACCENTS, TYPING_ANIMATIONS } from './settings/constants';
import {
  SunIcon, SystemIcon, MoonIcon, PaintIcon, SparkleIcon, MicIcon,
  FolderIcon, DatabaseIcon, UserIcon, InfoIcon, GitHubIcon,
  CloudUpIcon, CloudDownIcon, DownloadIcon, UploadIcon, ShieldIcon,
  RefreshIcon, PlugIcon, MessageSquareIcon, PickerIcon, PhoneIcon,
} from './settings/icons';
...
// Icon components imported from ./settings/icons
