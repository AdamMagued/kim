/**
 * Pure SVG icon components for SettingsPanel navigation and sections.
 *
 * Extracted from SettingsPanel.tsx (Phase 9 restructure).
 * No props, no state, no external dependencies beyond React JSX transform.
 */
