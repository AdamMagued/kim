        ...
        <main className="dm-settings-main">
          <section className="dm-settings-panel dm-settings-content">
            ...
            <div className="dm-setting-section"><div className="dm-option-grid">
              ...
              <div className="dm-setting-row"><div className="dm-setting-main-copy"><strong>Code sessions directory</strong><span className="dm-helper">Path where Codex stores its session files.</span></div><div className="dm-input-box">~/code/.codex/sessions</div></div>
